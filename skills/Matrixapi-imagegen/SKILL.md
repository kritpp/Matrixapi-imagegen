...
- Do not bypass an actual model refusal by obfuscating a name, switching languages, using spelling variants, or retrying with hidden visual cues. A specific upstream content, copyright, trademark, safety, or moderation refusal ends that task and is reported once. A generic 400/5xx remains an unknown provider error, not a rights verdict.
